    ...
    <>
      ...
      <div className="relative md:mt-20 mt-32 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="flex justify-center  flex-col items-center md:flex-row  md:justify-center md:items-center fhd:gap-14 lg:gap-10 md:gap-0 fhd:px-32 lg:px-10 xl:px-20 md:px-10 mt-10">
          ...
          <div className="card w-full md:p-6 lg:p-8 bg-[#9fabf7] rounded-lg border border-blue-500 shadow-[#50A8E1] shadow-xl fhd:min-h-[500px] lg:min-h-[400px] md:min-h-[auto] min-h-[300px]
 overflow-hidden">
            ...
            <div className="card w-full md:p-6 lg:p-8 bg-[#9fabf7] rounded-lg border border-blue-500 shadow-[#50A8E1] shadow-xlfhd:min-h-[500px] lg:min-h-[400px] md:min-h-[auto] min-h-[300px]
 overflow-hidden">
