      ...
      <div className="flex flex-wrap md:flex-nowrap justify-between items-center bg-[#111]/90 border border-[#4879e2] text-white mx-5 mb-10 rounded-lg backdrop-blur-sm py-5 ">
        <div className="flex flex-col md:flex-row w-full gap-5 md:gap-0 justify-between items-center md:px-10">
          ...
          <div className="flex flex-col md:flex-row items-center  md:gap-20">
            <div>
              <img src="white_logo_wlug.png" className="2xl:h-60 h-40 md:h-40 " alt="WLUG Logo" />
            </div>
        ...
        >
          <social.icon className="text-[#4879e2] 2xl:h-10 2xl:w-10 lg:h-6 lg:w-6 h-6 w-6 md:h-5 md:w-5 group-hover:text-[#0abfba]" />
            ...
            <div className="flex flex-col justify-center gap-5 items-center">
              <h1 className="title md:text-2xl text-1xl 2xl:text-4xl">Our Sponsors</h1>
          ...
          <div className="flex flex-col text-center justify-center gap-8 md:gap-5 items-center mt-5 md:mt-0">
            <div className="tracking-wider text-lg md:text-lg 2xl:text-4xl lg:text-1xl flex flex-wrap justify-center gap-6 md:gap-5">
              <a href="/"><h1 className="title cursor-pointer hover:text-[#4879e2]">Home</h1></a>
              <a href="https://www.wcewlug.org/"><h1 className="title cursor-pointer hover:text-[#4879e2]">About Us</h1></a>
              <a href="/"><h1 className="title cursor-pointer hover:text-[#4879e2]">Register</h1></a>
            </div>
            <div className="flex flex-wrap flex-col  md:flex-col lg:flex-row justify-center gap-3 2xl:text-xl text-sm md:text-[11px]  tracking-wider">
              <a href="https://github.com/Walchand-Linux-Users-Group/gitbook/blob/wiki/policies/privacy-policy.md" target="_blank"><h1 className="title font-thin cursor-pointer lg:border-r-2 lg:pr-3">Privacy Policy</h1></a>
              <a href="https://github.com/Walchand-Linux-Users-Group/gitbook/blob/wiki/policies/terms-and-conditions.md" target="_blank"><h1 className="title font-thin cursor-pointer lg:border-r-2 lg:px-3">Terms & Conditions</h1></a>
              <a href="https://github.com/Walchand-Linux-Users-Group/gitbook/blob/wiki/policies/cancellation-refund-policy.md" target="_blank"><h1 className="title font-thin cursor-pointer pl-3">Refund Policy</h1></a>
            </div>
          </div>
        </div>
      </div>
