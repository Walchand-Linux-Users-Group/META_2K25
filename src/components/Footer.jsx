...
export default function Footer() {
  return (
    <>
      ...
      <div className="flex flex-wrap md:flex-nowrap justify-between items-center bg-[#111]/60 border border-[#4879e2] text-white mx-5 mb-10 rounded-lg backdrop-blur-sm p-5">
