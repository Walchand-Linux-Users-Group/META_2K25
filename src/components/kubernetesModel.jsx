...
const KubernetesModel = () => {
  ...
  useEffect(() => {
    ...
    const directionalLightTopFrontRight = new THREE.DirectionalLight(
      0xf2f5f3,
      2
    );
    ...
    const directionalLightTopFrontLeft = new THREE.DirectionalLight(
      0xf2f5f3,
      2
    );
    ...
    const directionalLightBottomFrontRight = new THREE.DirectionalLight(
      0xf2f5f3,
      2
    );
    ...
    const directionalLightBottomFrontLeft = new THREE.DirectionalLight(
      0xf2f5f3,
      2
    );
